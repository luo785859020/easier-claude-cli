...
export type GlobalConfig = {
   ...
   * as Bearer tokens against OpenAI's API 鈥?they are never sent to Anthropic servers.
   */
  codexOAuth?: {
    accessToken: string
    refreshToken: string
  ...
  // /buddy companion state (soul + rolled bones). See src/buddy/.
  companion?: import('../buddy/types.js').StoredCompanion
  companionCollection?: import('../buddy/types.js').StoredCompanion[]
  ...
  speechOutputEnabled?: boolean // Read assistant replies aloud via TTS
